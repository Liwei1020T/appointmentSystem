...
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                             │
│  User ──1:N──▶ Order ──1:N──▶ OrderItem ──N:1──▶ StringInventory           │
│    │              │                                      │                  │
│    │              │1:1                                   │1:N               │
│    │              ▼                                      ▼                  │
│    │          Payment                               StockLog                │
...
│    │                                                                        │
│    ├──────────────▶ UserPackage ──N:1──▶ Package                           │
│    │                                                                        │
│    ├──────────────▶ UserVoucher ──N:1──▶ Voucher                           │
│    │                                                                        │
│    ├──────────────▶ PointsLog                                              │
│    │                                                                        │
│    ├──────────────▶ ReferralLog                                            │
...
### Model Summary (25 Total)

| Category | Models |
|----------|--------|
| **Auth** | User, Account, Session, VerificationToken, OtpCode |
| **User Extensions** | UserBadge, TierBenefit |
| **Orders** | Order, OrderItem, OrderStatusLog, Payment |
| **Inventory** | StringInventory, StockLog |
| **Reviews** | Review, ReviewLike |
| **Packages** | Package, UserPackage |
| **Vouchers** | Voucher, UserVoucher |
| **Points/Referrals** | PointsLog, ReferralLog |
| **Marketing** | Promotion, PromotionUsage |
| **System** | Notification, SystemSetting |
...
User accounts managed by NextAuth.js with extended business profile data.
...
**Notes:**
- Review APIs are implemented in Next.js App Router (`/api/reviews/*`) and persist via Prisma ORM.
