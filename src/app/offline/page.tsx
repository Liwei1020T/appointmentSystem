  ...
  return (
    <div className="min-h-screen bg-ink flex items-center justify-center p-4">
      <div className="max-w-md w-full text-center space-y-6">
        {/* 图标 */}
        <div className="w-24 h-24 mx-auto bg-accent-soft rounded-full flex items-center justify-center">
        ...
        {/* 提示 */}
        <div className="bg-white rounded-xl border border-border-subtle p-4 text-left space-y-3">
