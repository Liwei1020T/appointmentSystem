    ...
    <div className="min-h-screen bg-ink pb-12">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-6 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card className="p-6">
            <p className="text-sm font-medium text-text-secondary">总销售额</p>
          ...
          <Card className="p-6">
            <p className="text-sm font-medium text-text-secondary">用户 LTV (生命周期价值)</p>
            <p className="text-3xl font-bold text-accent mt-2 font-mono">
              {formatCurrency(ltv.ltv)}
            </p>
            <p className="text-xs text-text-tertiary mt-1">基于 {ltv.totalUsers} 位用户</p>
          </Card>

          <Card className="p-6">
            <p className="text-sm font-medium text-text-secondary">用户留存率</p>
          ...
          <Card className="p-6">
            <p className="text-sm font-medium text-text-secondary">总订单数</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <Card className="p-6 lg:col-span-2">
            <h3 className="text-lg font-bold text-text-primary mb-4">客单价与销售趋势 (12个月)</h3>
            <LtvChart data={aovTrend} />
          </Card>

          {/* Retention (Pie Chart) */}
          <Card className="p-6">
            <h3 className="text-lg font-bold text-text-primary mb-4">用户构成</h3>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-1 gap-6">
          <Card className="p-6">
            <h3 className="text-lg font-bold text-text-primary mb-4">热门下单时段 (小时)</h3>
