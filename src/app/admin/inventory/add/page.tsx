    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-6">
          ...
          <h1 className="text-2xl font-bold text-gray-900">添加新球线</h1>
        </div>
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            <div className="space-y-6">
              ...
              <div className="border-t border-gray-200 pt-6">
                <h2 className="text-lg font-semibold text-gray-900 mb-4">定价信息</h2>
                ...
                {formData.selling_price > 0 && formData.cost_price > 0 && (
                  <div className="mt-4 p-4 bg-green-50 border border-green-200 rounded-lg">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="text-sm text-gray-600">单条利润</p>
              ...
              {/* Stock Section */}
              <div className="border-t border-gray-200 pt-6">
                <h2 className="text-lg font-semibold text-gray-900 mb-4">库存信息</h2>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      min="0"
                    />
                    <p className="text-xs text-gray-500 mt-1">可以先设为0，之后再补货</p>
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      required
                    />
                    <p className="text-xs text-gray-500 mt-1">低于此值时会显示警告</p>
                  </div>
                </div>
              </div>
            </div>
