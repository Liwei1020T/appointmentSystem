  ...
  return (
    <nav className="sticky top-0 z-40">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-4 relative">
        <div className="flex justify-between h-16 rounded-2xl surface-nav backdrop-blur-md border shadow-sm px-4">
          {/* Logo */}
        ...
        {mobileMenuOpen && (
          <div className="md:hidden absolute left-0 right-0 top-full surface-card border shadow-lg py-3 space-y-1 z-50 rounded-2xl mt-3">
            {status === 'authenticated' ? (
              <>
                <Link
                  href="/booking"
