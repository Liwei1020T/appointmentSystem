...
export default function VoucherSelector({ orderAmount, selectedVoucher, onSelect }: VoucherSelectorProps) {
  ...
  return (
    <>
      <Card onClick={() => setShowModal(true)} className="cursor-pointer hover:bg-slate-50 transition-colors">
        <div className="p-4">
          ...
          <div className="space-y-3 max-h-96 overflow-y-auto">
            {vouchers.length === 0 ? (
              ...
              <>
                ...
                >
                  <div className="p-4">
                    <p className="font-medium text-slate-900">不使用优惠券</p>
                  </div>
                </Card>
